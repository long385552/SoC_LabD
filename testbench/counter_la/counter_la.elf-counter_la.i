# 0 "counter_la.c"
# 1 "/home/ubuntu/Desktop/LabD/testbench/counter_la//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "counter_la.c"
# 19 "counter_la.c"
...
void main()
{
 ...
 int* task_mm = matmul();
 (*(volatile uint32_t*)0x2600000c) = *(task_mm+0) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(task_mm+1) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(task_mm+2) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(task_mm+3) << 16;
